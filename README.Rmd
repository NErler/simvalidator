...
The goal of simvalidator is to perform simulation analysis to validate model
results, and to present these results in Rmarkdown documents.
...
sim_out <- run_sim(sim_params, covar_def, data_params, models)
